...
<body>
	...
	<form action='' method='post' class="calculate-form">
		...
		<input class="submit_form" type="submit" name="submit" value="Получить результат">
		<input class="reset" name="reset" value="Обнулить результат" type="submit"/> 
	</form>
</body>
</html>
...
if(isset($_POST['submit'])){
    ...
    if(isset($error_result)){
	    ...
	    echo "<div class='answer-text'>Результат: $result</div>";
    }
}
?>
